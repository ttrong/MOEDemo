...
import 'package:moe_cfims/domain/account/i_account_repository.dart';
import 'package:moe_cfims/infrastructure/account/account_dto.dart';
...
class AccountRepository extends IAccountRepository {
  ...
  Future<Either<AccountFailure, Account>> getAccount() async {
    try {
      final response = await _dio.get(ApiConstant.getProfile);
  ...
  void _setUserData(Account account) {
    ...
    if (!Platform.environment.containsKey('FLUTTER_TEST')) {
      ...
      box.put(BoxKeys.currentAccount, AccountEntity.fromDomain(account));
    }
  }
}
